...
if offsets[0].offset == -1:
    ...
    with open('/home/team25/Milestone2/_SHARED_DATA_POOL/training_set/rate_log.csv', mode='w', newline='') as rate_file, \
         open('/home/team25/Milestone2/_SHARED_DATA_POOL/training_set/user.csv', mode='w', newline='') as user_file:
