...
def obtain_prerequisites():
    model_path = current_directory + '/../_SHARED_DATA_POOL/model/svd_model.joblib'
    df_path = current_directory + '/../_SHARED_DATA_POOL/training_set/rate_log.csv'
    user_info_df_path = current_directory + '/../_SHARED_DATA_POOL/training_set/user.csv'
...
def generate_recommendations_for_all_training_users(model, df, user_info_df):
    ...
    recommendations_path = current_directory + '/../_SHARED_DATA_POOL/model/recommendations.csv'
